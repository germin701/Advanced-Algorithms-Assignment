...
print("Adjacent vertices of A: ")
graph1.listAdjacentVertex('A')
print("\nSum of weights for the vertex A:", graph1.sumHighestAdjacentVertex('A'))
...
print("Adjacent vertices of J: ")
graph2.listAdjacentVertex('J')
print("\nSum of weights for the vertex J:", graph2.sumHighestAdjacentVertex('J'))
